"""
51차 (49차 3단계 — extra_trees 기준) — LightGBM 재탐색 (블렌드 주력 축이 된 뒤 처음)
...
OUT='/home/lee/lga/results51/'; os.makedirs(OUT,exist_ok=True)
...
GA=[('기준 leaves10+ET', {}),
    ...
    ('leaves31+n2400',dict(num_leaves=31, n_estimators=2400, learning_rate=0.005))]
GB=[('기준 leaves10+ET', {}),
    ...
    ('cs.15+mcs12000',dict(colsample_bytree=0.15, min_child_samples=12000))]
