"""
49차 — LightGBM 재탐색 (블렌드 주력 축이 된 뒤 처음)
...
OUT='/home/lee/lga/results49/'; os.makedirs(OUT,exist_ok=True)
...
log(f'{el()} [{GRP}] v16 기준 {X.shape[1]} 피처 · 스레드 {NTH}')
