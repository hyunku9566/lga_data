"""
54차 — CatBoost 2단계 (depth4 + bagging_temperature 조합) (블렌드 3번째 축, 한 번도 제대로 튜닝 안 함)
...
배경
  ...
  2단계 기준: depth4 + bagging_temperature2 (52차에서 각각 +62.7/+88.2, +72.3/+81.6)
...
OUT='/home/lee/lga/results54/'; os.makedirs(OUT,exist_ok=True)
...
BASE=dict(iterations=2000, learning_rate=0.03, depth=4, l2_leaf_reg=50., bagging_temperature=2.,
...
GA=[('기준 d4+bt2', {}),
    ('depth3',        dict(depth=3)),
    ('depth5',        dict(depth=5)),
    ('bagtemp5',      dict(bagging_temperature=5.)),
    ('bagtemp1',      dict(bagging_temperature=1.)),
...
GB=[('기준 d4+bt2', {}),
    ...
    ('l2_500+n4000',  dict(l2_leaf_reg=500., iterations=4000, learning_rate=0.015))]
